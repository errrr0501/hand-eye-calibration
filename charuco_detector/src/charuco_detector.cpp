...
namespace charuco_detector {
	...
	void ChArUcoDetector::setupConfigurationFromParameterServer(ros::NodeHandlePtr &_node_handle, ros::NodeHandlePtr &_private_node_handle) {
		...
		private_node_handle_->param("charuco/squaresSidesSizeM", squares_sides_size_m_, 0.0200);
		private_node_handle_->param("charuco/markersSidesSizeM", markers_sides_size_m_, 0.0150);
	...
	void ChArUcoDetector::getCameraCalibrationCoefficient() {
		...
		inih::INIReader Camera_KD{"/home/hiwin/work/hand_eye_calibration_ws/src/hand-eye-calibration/charuco_detector/config/camera_calibration/camera_calibration.ini"};
