...
class GenerateHandEyePoint(EventState):
	...
	def execute(self, userdata):
		...
		if self.move_distance <= 11.0:
			...
			baseltrans = tf.transformations.translation_matrix((self._current_pose.pose.position.x, self._current_pose.pose.position.y, self._current_pose.pose.position.z))
			baserot = tf.transformations.quaternion_matrix((self._current_pose.pose.orientation.x, self._current_pose.pose.orientation.y, self._current_pose.pose.orientation.z, self._current_pose.pose.orientation.w))
